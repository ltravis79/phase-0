...
//    I had an issue adding the individual children, specifically the first one, Carson.  By 
//    trying to put the entire statement on one line, I initially included an extra simicolon 
//    inside the braces, as if it were a function inside the braces, not properties.  Once I 
//    realized I had the wrong syntax it worked well.

// How difficult was it to add and delete properties outside of the object itself?
//    Adding properties was very easy outside of the object, you just write a statement 
//    that includes the property name you want and the value you want to give it.
//    Deleting was a little more difficult at first.  I didn't remember how to do that, 
//    so at first I tried assigning the property to "" but that didn't pass the test.  I 
//    eventually had to google the syntax as a reminder, at which point it was pretty easy.

// What did you learn about manipulating objects in this challenge?
//    Deleting properties was a little new to me.  The output of the final object was also 
//    a nice visual representation of the way objects can nest within eachother, .
//
//
//
//
